  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          'animate-rise fixed inset-x-0 bottom-0 z-50 flex max-h-[88vh] flex-col rounded-t-xl border border-border bg-background shadow-lg',
          'sm:inset-y-0 sm:right-0 sm:left-auto sm:w-[440px] sm:max-h-none sm:rounded-t-none sm:rounded-l-xl sm:animate-fade',
          className,
        )}
        {...props}
      >
