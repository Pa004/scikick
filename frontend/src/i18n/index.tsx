...
const DICTIONARIES = {
  en: {
    ...
    momentum: 'Momentum',
    basedOnLoaded: 'Based on loaded fixtures',
    ...
    sortBy: 'Sort by',
    trustTitle: 'Why trust these numbers',
  ...
  es: {
    ...
    momentum: 'Momento',
    basedOnLoaded: 'Basado en partidos cargados',
    ...
    sortBy: 'Ordenar por',
    trustTitle: 'Por qué confiar en estos números',
